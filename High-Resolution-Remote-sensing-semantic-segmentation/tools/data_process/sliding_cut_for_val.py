...
if __name__ == "__main__":
    ...
    patch_size = 512
    stride = 512
    input_path = r"D:\dataset\Graduation_project\Potsdam\val"
    output_path = r"D:\dataset\Graduation_project\Potsdam\val\{}_final".format(patch_size)
    ...
    for filename in os.listdir(os.path.join(input_path, input_dir_list[0])):
        ...
        label_path = os.path.join(input_path, input_dir_list[1], filename.replace('_RGB.tif', '_label.tif'))
