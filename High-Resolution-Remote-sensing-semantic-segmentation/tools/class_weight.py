...
if __name__ == "__main__":
    # Dataset
    dataset = RSDataset(root='D:\\dataset\\Graduation_project\\GID\\train\\256', mode='train')
    ...
    for i in range(len(five_classes())):
        table.add_row([i, five_classes()[i], num_pixel[i], weight[i]])
    print(table)
