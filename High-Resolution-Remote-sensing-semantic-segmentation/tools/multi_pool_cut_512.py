...
if __name__ == "__main__":
    ...
    parser.add_argument("-image-path", type=str, default=r"D:\dataset\Graduation_project\GID\val\label\GF2_PMS2__L1A0000607681-MSS2_label.tif")
    parser.add_argument("-save-dir", type=str, default=r"D:\dataset\Graduation_project\GID\paper_result\label_multi_pool_cut\\")
    # parser.add_argument("-save-dir", type=str, default=r"./data_512/")
    arg = parser.parse_args()
    image_n = arg.image_n
    image_path = arg.image_path

    save_image_dir = os.path.join(arg.save_dir, "607681")
    stride = 256
    target_size = (512, 512)
    ...
    # building_image = np.array(Image.open(image_path).convert('RGB'))
