...
class FCN_GCN(nn.Module):
    def __init__(self, num_classes):
        ...
        self.gcn2 = GCN(512, self.num_classes, 27)
    ...
    def forward(self, x):
        ...
        gc_fm4 = F.upsample_bilinear(gc_fm4, fm3.size()[2:])
        gc_fm3 = F.upsample_bilinear(self.br5(gc_fm3 + gc_fm4), fm2.size()[2:])
        gc_fm2 = F.upsample_bilinear(self.br6(gc_fm2 + gc_fm3), fm1.size()[2:])
        gc_fm1 = F.upsample_bilinear(self.br7(gc_fm1 + gc_fm2), pooled_x.size()[2:])

        gc_fm1 = F.upsample_bilinear(self.br8(gc_fm1), scale_factor=2)

        out = F.upsample_bilinear(self.br9(gc_fm1), input.size()[2:])
